...
<div style="background-color: #f5f5f5; padding: 1em; border-radius: 8px;">
  <p>
    We are thrilled to unveil our latest breakthroughs, <code>POLARIS-7B-Preview</code> and <em>POLARIS-4B-Preview</em>, which mark a new frontier in open‐recipe reasoning models developed using academic‐level resources. 
    <br>
...
<div>
  ...
  <div style="background-color: #ffffff; padding: 1em; border-radius: 8px; margin-bottom: 10px;">
    <p style="margin: 0;">
  ...
  <div style="background-color: #f5f5f5; padding: 1em; border-radius: 8px; margin-bottom: 10px;">
    <p style="margin: 0;">
