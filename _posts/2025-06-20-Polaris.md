...
_styles: >
  ...
  html[data-theme="dark"] .polaris-box,
  body.dark .polaris-box {
    background-color: #2a2a2a;
    color: #e0e0e0;
  }
  html[data-theme="dark"] .polaris-box a,
  body.dark .polaris-box a {
    color: #6db3f2;
  }
  html[data-theme="dark"] .polaris-box code,
  body.dark .polaris-box code {
    background-color: #3a3a3a;
    color: #e0e0e0;
  }
  html[data-theme="dark"] .takeaway-light,
  body.dark .takeaway-light {
    background-color: #1e1e1e;
    color: #e0e0e0;
  }
  html[data-theme="dark"] .takeaway-dark,
  body.dark .takeaway-dark {
    background-color: #2a2a2a;
    color: #e0e0e0;
  }
---
