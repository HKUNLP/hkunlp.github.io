...
<!-- Given by the comparison above, we would like a general framework that attempts to get the best of both worlds, combining both the efficiency of RFA and the expressiveness of RA. In particular,
- the SNIS formulation of RFA is essential to achieve linear complexity, since
...
- the adaptive and query-specific characteristic of RA is essential to improve the expressiveness. -->
